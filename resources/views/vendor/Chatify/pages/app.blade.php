...
<div  class="messenger">
    ...
    <div class="messenger-listView {{ !!$id ? 'conversation-active' : '' }}">
        ...
        <div class="m-header">
            <nav>
                <a href="#"><i class="fas fa-inbox"></i> <span class="messenger-headTitle">Vos messages</span> </a>
                {{-- header buttons --}}
        ...
        <div id="contactLoad" class="m-body contacts-container">
           ...
           <div class="show messenger-tab users-tab app-scroll" data-view="users">
               ...
               {{-- Saved Messages --}}
               <p class="messenger-title"><span>Ton espace</span></p>
               {!! view('Chatify::layouts.listItem', ['get' => 'saved']) !!}
               {{-- Contact --}}
               <p class="messenger-title"><span>Tout les messages</span></p>
           ...
           <div class="messenger-tab search-tab app-scroll" data-view="search">
                ...
                <div class="search-records">
                    <p class="message-hint center-el"><span>Cliquez pour rechercher..</span></p>
                </div>
             </div>
        </div>
    </div>
    ...
    <div class="messenger-messagingView">
        ...
        <div class="m-header m-header-messaging">
            ...
            <div class="internet-connection">
                ...
                <span class="ic-noInternet">Pas d'acces a internet</span>
            </div>
        </div>
        ...
        <div class="m-body messages-container app-scroll">
            <div class="messages">
                <p class="message-hint center-el"><span>Selectionnez une discussion pour commencer a chatter</span></p>
            </div>
            {{-- Typing indicator --}}
